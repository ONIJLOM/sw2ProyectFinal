...
class UserSeeder extends Seeder
{
    ...
    public function run(){
        ...
        Configuration::create([
                'razon_social' => 'Hipermaxi',
                'factura' => '123456789',
                'email' => 'Hipermaxi@gmail.com',
        ...
        Sucursal::create([
            'nombre' => 'Hipermaxi - Plan 3000',
            'direccion' => 'https://goo.gl/maps/CkqQUgMcvUgUCEYA8',
        ]);

        Sucursal::create([
            'nombre' => 'Hipermaxi - Las Palmas',
            'direccion' => 'https://goo.gl/maps/pTKsujxQkThBZu6C6',
        ]);

        Sucursal::create([
            'nombre' => 'Hipermaxi - Santos Dumont',
            'direccion' => 'https://goo.gl/maps/B3CNsNy5xdTN8H9Y9',
        ]);
    }
}
