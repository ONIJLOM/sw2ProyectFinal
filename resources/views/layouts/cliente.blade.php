...
<head>
    ...
    $dato = DB::table('configurations')
        ->where('id', 1)
        ->first(); ?>
    <title>@yield('title') - HIPERMAXI</title>
    <meta charset="UTF-8">
...
<body class="leading-normal tracking-normal">
    <div class="main-content flex-1 bg-gray-100 border-black">
        <div class="w-full text-gray-700 bg-red-600 orange-mode:text-red-200 dark-mode:bg-red-800">
            <div x-data="{ open: false }"
                ...
                <div class="p-4 flex flex-row items-center justify-between bg-red-600">
                    ...
                    <a href="{{route('home')}}"
                        class="text-2xl font-semibold tracking-widest text-white uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Hipermaxi</a>
                </div>
    ...
    <footer class="bg-red-600 border-t-2 border-black">
        <div class="max-w-screen-xl px-4 py-6 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            ...
            <p class="mt-8 text-base leading-6 text-center text-white">
                © 2021 Hipermaxi, Inc. All rights reserved.
            </p>
        </div>
    </footer>
