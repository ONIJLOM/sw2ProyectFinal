...
class PedidosCController extends Controller
{
    ...
    public function seeSucursales($id)
    {
        $sucursales = DB::table('producto_sucursal')->where('producto_id', $id)->get();
        $producto = Producto::where('id', $id)->first();
        return view('cliente.verSucursales', compact('sucursales', 'producto'));
    }
