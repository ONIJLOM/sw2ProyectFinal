...
class detalle_pedidoController extends Controller
{
      ...
      public function productoMasVendido()
    {
        ...
        $productoMasVendido = Producto::orderBy('ventas', 'desc')->first(); // Ajusta según la lógica de tu aplicación

        return view('admin.dashboard.productoMasVendido', compact('productoMasVendido'));
    }
    public function categoriaMasVendida()
    {
        // Lógica para obtener la categoría más vendida
        // En este ejemplo, obtenemos la categoría con más ventas (debes ajustarlo según tu lógica)
        $categoriaMasVendida = Categoria::orderBy('ventas', 'desc')->first();

        return view('admin.dashboard.categoriaMasVendida', compact('categoriaMasVendida'));
    }
    public function totalVentas()
    {
        ...
        return view('admin.dashboard.totalVentas', compact('totalVentas'));
    }
}
