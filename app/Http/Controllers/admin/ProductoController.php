...
class ProductoController extends Controller
{
    ...
    public function create(){
        ...
        return view('admin.productos.create', compact('categoria','marca', 'sucursales'));
    }
    ...
    public function store(Request $request){
        ...
        $producto->sucursales()->sync($request->sucursales);
    ...
    public function edit(Producto $producto){
        ...
        $marca = Marca::all();
        $sucursales = Sucursal::all();
        return view('admin.productos.edit', compact('producto','categoria','marca', 'sucursales'));
    }
