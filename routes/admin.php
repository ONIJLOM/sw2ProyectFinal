...
Route::get('sucursales',[sucursalController::class,'index'])->name('admin.sucursal.index');
Route::get('sucursales/create',[sucursalController::class,'create'])->name('admin.sucursal.create');
Route::post('sucursales/create/store',[sucursalController::class,'store'])->name('admin.sucursal.store');
Route::get('sucursales/edit/{id}',[sucursalController::class,'edit'])->name('admin.sucursal.edit');
Route::put('sucursales/edit/update/{id}',[sucursalController::class,'update'])->name('admin.sucursal.update');
Route::post('sucursales/destroy/{id}',[sucursalController::class,'destroy'])->name('admin.sucursal.destroy');